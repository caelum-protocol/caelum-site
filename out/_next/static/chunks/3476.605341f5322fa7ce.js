"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[3476],{83476:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ev,W3mModal:()=>em,W3mModalBase:()=>eh});var o=i(1850),a=i(85721),r=i(12689),s=i(96853),n=i(2928),c=i(61434),l=i(933),w=i(70803),d=i(70464),p=i(51105),u=i(49629);let h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled())return void c.W.shake();c.W.close()}};var m=i(90889),v=i(82570),g=i(21159),y=i(55822),f=i(54684),b=i(51127);let k=(0,o.AH)`
  :host {
    display: block;
...
`,(0,o.qy)`
    ...
    `}};j.styles=[f.W5,f.fD,f.ck,P],D([(0,a.MZ)()],j.prototype,"size",void 0),D([(0,a.MZ)({type:Boolean})],j.prototype,"disabled",void 0),D([(0,a.MZ)()],j.prototype,"icon",void 0),D([(0,a.MZ)()],j.prototype,"iconColor",void 0),j=D([(0,b.E)("wui-icon-link")],j),i(56349),i(49145);let H=(0,o.AH)`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var M=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let B=class extends o.WF{constructor(){super(...arguments),this.imageSrc=""}render(){return(0,o.qy)`<button>
    ...
    ></wui-icon-box>`}};B.styles=[f.W5,f.fD,f.ck,H],M([(0,a.MZ)()],B.prototype,"imageSrc",void 0),B=M([(0,b.E)("wui-select")],B),i(1610),i(60347);var L=i(22483);let z=(0,o.AH)`
  :host {
    height: 64px;
  }
...
`;var G=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let J={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}},Q=class extends o.WF{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=v.P.state.open,this.unsubscribe.push(v.P.subscribeKey("open",e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){let{message:e,variant:t,svg:i}=v.P.state,a=J[t],{icon:r,iconColor:s}=i??a??{};return(0,o.qy)`
      <wui-snackbar
        ...
        .loading=${"loading"===t}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),v.P.state.autoClose&&(this.timeout=setTimeout(()=>v.P.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};Q.styles=Y,G([(0,a.wk)()],Q.prototype,"open",void 0),Q=G([(0,y.EM)("w3m-snackbar")],Q);var ee=i(1274),et=i(81334),ei=i(41228);let eo=(0,ee.BX)({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ea=(0,ei.X)({state:eo,subscribe:e=>(0,ee.B1)(eo,()=>e(eo)),subscribeKey:(e,t)=>(0,et.u$)(eo,e,t),showTooltip({message:e,triggerRect:t,variant:i}){eo.open=!0,eo.message=e,eo.triggerRect=t,eo.variant=i},hide(){eo.open=!1,eo.message="",eo.triggerRect={width:0,height:0,top:0,left:0}}});i(80729);let er=(0,o.AH)`
  :host {
    pointer-events: none;
  }
